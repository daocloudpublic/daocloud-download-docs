...
| ------- | --- | ---- | ------ | --- | ------- |
| offline-v0.39.1-amd64.tar | v0.39.1 | AMD 64 | 35.08GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.39.1-amd64.tar) | 2026-05-15 |
| offline-v0.39.1-arm64.tar | v0.39.1 | <font color="green">ARM 64</font> | 31.70GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.39.1-arm64.tar) | 2026-05-15 |
...
=== "AMD 64"
    ...
    ```sh
    echo "80f687b3eb15cebde91d023c1c15f5b52ec0f624a80b2bf72e2dbc0e4805f343047fcd3487cc5fe301cbcd782295f79e804e4f06794b508fe111c92d25b725a2  offline-v0.39.1-amd64.tar" | sha512sum -c
    ```

    校验成功会打印：

    ```none
    offline-v0.39.1-amd64.tar: OK
    ```
...
=== "<font color="green">ARM 64</font>"
    ...
    ```sh
    echo "09cb41fee39a34079cf598dafaa15d1b7a910a6dacb418b8d36fbdb9453cb3a134ddcc7f0a280376be72fe570fbfe43056c69e364d1e2bf62e6d4cedb9706ac1  offline-v0.39.1-arm64.tar" | sha512sum -c
    ```

    校验成功会打印：

    ```none
    offline-v0.39.1-arm64.tar: OK
    ```
...
=== "AMD 64"
    ...
    ```sh
    tar -zxvf offline-v0.39.1-amd64.tar
    ```
...
=== "<font color="green">ARM 64</font>"
    ...
    ```sh
    tar -zxvf offline-v0.39.1-arm64.tar
    ```
