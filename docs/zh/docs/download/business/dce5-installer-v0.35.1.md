...
| ------- | --- | ---- | ------ | --- | ------- |
| offline-v0.35.1-amd64.tar | v0.35.1 | AMD 64 | 34.39GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.35.1-amd64.tar) | 2025-12-09 |
| offline-v0.35.1-arm64.tar | v0.35.1 | <font color="green">ARM 64</font> | 31.13GB | [:arrow_down: 下载](https://qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-v0.35.1-arm64.tar) | 2025-12-09 |
...
=== "AMD 64"
    ...
    ```sh
    echo "558a2879b4f90fc3fa387ae2c2040e983e133baea471efb0564fafc9cda9f61dc5d6852800ea2333e1b1bd7b18b718c5b3ccb596910924229b26eea19b17ba53  offline-v0.35.1-amd64.tar" | sha512sum -c
    ```

    校验成功会打印：

    ```none
    offline-v0.35.1-amd64.tar: OK
    ```
...
=== "<font color="green">ARM 64</font>"
    ...
    ```sh
    echo "d6906622c126fd758ae4e2a89c9f48ce85dc7eeca9e0f7809cc85d98e118416a2ab2e0db211ab7ca8784bf1301bb7557b0565551893da760135ee2c680aa5b63  offline-v0.35.1-arm64.tar" | sha512sum -c
    ```

    校验成功会打印：

    ```none
    offline-v0.35.1-arm64.tar: OK
    ```
...
=== "AMD 64"
    ...
    ```sh
    tar -zxvf offline-v0.35.1-amd64.tar
    ```
...
=== "<font color="green">ARM 64</font>"
    ...
    ```sh
    tar -zxvf offline-v0.35.1-arm64.tar
    ```
